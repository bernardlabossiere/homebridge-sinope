...
exports.SinopeDimmerAccessory = exports.SinopeOutletAccessory = exports.SinopeSwitchAccessory = exports.SinopeThermostatAccessory = void 0;
 ...
 */
class SinopeThermostatAccessory {
    constructor(platform, accessory, device) {
        this.platform = platform;
        this.accessory = accessory;
        this.device = device;
        this.state = new StateThermostat();
        ...
        this.service.getCharacteristic(this.platform.Characteristic.TargetTemperature)
            .setProps({ minValue: 8, minStep: 0.5 })
    ...
    async handleTargetHeatingCoolingStateSet(value, callback) {
        ...
        const body = { setpointMode: setpointMode };
        try {
    ...
    async handleTargetTemperatureSet(value, callback) {
        ...
        const body = { roomSetpoint: Number(value) };
        try {
            await this.platform.neviweb.updateThermostat(this.device.id, body);
            this.platform.log.debug('updated device %s with TargetTemperature %d', this.device.name, value);
        }
...
exports.SinopeThermostatAccessory = SinopeThermostatAccessory;
class SinopeSwitchAccessory {
    constructor(platform, accessory, device) {
        this.platform = platform;
        this.accessory = accessory;
        this.device = device;
    ...
    async updateState() {
        ...
        try {
            ...
            this.service.updateCharacteristic(this.platform.Characteristic.On, this.state.onOff);
        }
        catch (error) {
            this.platform.log.error('could not fetch update for device %s from Neviweb API', this.device.name);
        }
...
exports.SinopeSwitchAccessory = SinopeSwitchAccessory;
class SinopeOutletAccessory {
    constructor(platform, accessory, device) {
        this.platform = platform;
        this.accessory = accessory;
        this.device = device;
...
exports.SinopeOutletAccessory = SinopeOutletAccessory;
class SinopeDimmerAccessory {
    constructor(platform, accessory, device) {
        this.platform = platform;
        this.accessory = accessory;
        this.device = device;
        this.state = new StateDimmer();
        // set accessory information
        this.accessory.getService(this.platform.Service.AccessoryInformation)
            .setCharacteristic(this.platform.Characteristic.Manufacturer, this.device.vendor)
            .setCharacteristic(this.platform.Characteristic.Model, this.device.sku)
    ...
    async handleBrightnessSet(value, callback) {
        ...
        const body = { intensity: Number(value) };
        try {
    ...
    async updateState() {
        ...
        try {
            ...
            this.service.updateCharacteristic(this.platform.Characteristic.Brightness, this.state.intensity);
        }
        catch (error) {
            this.platform.log.error('could not fetch update for device %s from Neviweb API', this.device.name);
        }
...
exports.SinopeDimmerAccessory = SinopeDimmerAccessory;
