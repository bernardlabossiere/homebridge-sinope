...
exports.SinopePlatform = void 0;
const settings_1 = require("./settings");
const platformAccessory_1 = require("./platformAccessory");
const neviweb_1 = require("./neviweb");
...
class SinopePlatform {
    constructor(log, config, api) {
        ...
        this.neviweb = new neviweb_1.NeviwebApi(this.config, log);
        ...
        for (const thermostat of thermostats) {
            ...
            if (existingAccessory) {
                ...
                if (thermostat) {
                    ...
                    new platformAccessory_1.SinopeThermostatAccessory(this, existingAccessory, thermostat);
                ...
                // this is imported from `platformAccessory.ts`
                new platformAccessory_1.SinopeThermostatAccessory(this, accessory, thermostat);
        ...
        for (const aswitch of switches) {
            ...
            if (existingAccessory) {
                ...
                if (aswitch) {
                    ...
                    // create the accessory handler for the restored accessory
                    // this is imported from `platformAccessory.ts`
                    new platformAccessory_1.SinopeSwitchAccessory(this, existingAccessory, aswitch);
                    // update accessory cache with any changes to the accessory details and information
                    this.api.updatePlatformAccessories([existingAccessory]);
                }
                else if (!aswitch) {
                ...
                // create the accessory handler for the newly create accessory
                // this is imported from `platformAccessory.ts`
                new platformAccessory_1.SinopeSwitchAccessory(this, accessory, aswitch);
                // link the accessory to your platform
                this.api.registerPlatformAccessories(settings_1.PLUGIN_NAME, settings_1.PLATFORM_NAME, [accessory]);
            }
        }
        for (const outlet of outlets) {
            ...
            if (existingAccessory) {
                ...
                if (outlet) {
                    ...
                    // create the accessory handler for the restored accessory
                    // this is imported from `platformAccessory.ts`
                    new platformAccessory_1.SinopeOutletAccessory(this, existingAccessory, outlet);
                    // update accessory cache with any changes to the accessory details and information
                    this.api.updatePlatformAccessories([existingAccessory]);
                }
                else if (!outlet) {
                ...
                // create the accessory handler for the newly create accessory
                // this is imported from `platformAccessory.ts`
                new platformAccessory_1.SinopeOutletAccessory(this, accessory, outlet);
                // link the accessory to your platform
                this.api.registerPlatformAccessories(settings_1.PLUGIN_NAME, settings_1.PLATFORM_NAME, [accessory]);
            }
        }
        for (const dimmer of dimmers) {
            ...
            if (existingAccessory) {
                ...
                if (dimmer) {
                    ...
                    // create the accessory handler for the restored accessory
                    // this is imported from `platformAccessory.ts`
                    new platformAccessory_1.SinopeDimmerAccessory(this, existingAccessory, dimmer);
                    // update accessory cache with any changes to the accessory details and information
                    this.api.updatePlatformAccessories([existingAccessory]);
                }
                else if (!dimmer) {
                ...
                // create the accessory handler for the newly create accessory
                // this is imported from `platformAccessory.ts`
                new platformAccessory_1.SinopeDimmerAccessory(this, accessory, dimmer);
                // link the accessory to your platform
                this.api.registerPlatformAccessories(settings_1.PLUGIN_NAME, settings_1.PLATFORM_NAME, [accessory]);
            }
        }
...
exports.SinopePlatform = SinopePlatform;
